...
### Why it matters
Small models often struggle with complex logic. By providing them with the "thoughts" (CoT) of a larger model, we can bridge the reasoning gap. This allows Albert to run incredibly smart agents on lower-powered devices without sacrificing depth.
